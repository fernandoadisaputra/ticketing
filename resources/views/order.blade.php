        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8">
            ...
            <form action="{{ route('customer.order.process') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    {{-- Hidden field untuk ticket_type_id --}}
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="quantity" id="quantity" min="1" max="20" value="{{ old('quantity', 1) }}"
                        class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200"
                        required>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <select name="payment_method" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200" required>
                        ...
                        <option value="bank_transfer" {{ old('payment_method') == 'bank_transfer' ? 'selected' : '' }}>Transfer Bank (Virtual Account)</option>
