...
<body class="bg-gray-50 font-sans antialiased text-gray-900 selection:bg-brand-500 selection:text-white">
    ...
    <nav class="absolute w-full z-50 transition-all duration-300 py-4 px-6 md:px-12 flex justify-between items-center">
        ...
        <div class="flex items-center space-x-2 md:space-x-4">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(url('/dashboard')); ?>" class="bg-brand-500 text-white px-4 py-2 md:px-6 md:py-2.5 text-sm md:text-base whitespace-nowrap rounded-full font-bold hover:bg-brand-600 hover:shadow-lg transition">Dashboard</a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="bg-white/20 backdrop-blur-md border border-white/30 text-white px-4 py-2 md:px-6 md:py-2.5 text-sm md:text-base whitespace-nowrap rounded-full font-bold hover:bg-white/30 transition">Log in</a>
                <a href="<?php echo e(route('register')); ?>" style="background-color: #f97316; color: white;" class="px-4 py-2 md:px-6 md:py-2.5 text-sm md:text-base whitespace-nowrap rounded-full font-bold hover:opacity-90 hover:shadow-lg transition transform hover:-translate-y-0.5">Daftar</a>
            <?php endif; ?>
        </div>
    </nav>
    ...
    <div class="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                <a href="<?php echo e(route('customer.order')); ?>" class="bg-brand-500 text-white font-bold px-8 py-4 rounded-full shadow-[0_0_20px_rgba(20,184,166,0.4)] hover:shadow-[0_0_30px_rgba(20,184,166,0.6)] hover:-translate-y-1 transition transform duration-300 text-lg flex items-center justify-center gap-2">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"></path></svg>
                    Pesan Tiket Sekarang
                </a>
                <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('register')); ?>" style="background-color: #f97316; color: white;" class="font-bold px-8 py-4 rounded-full shadow-lg hover:opacity-90 transition transform duration-300 text-lg flex items-center justify-center gap-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div class="group bg-white rounded-3xl shadow-sm border border-gray-100/50 overflow-hidden hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
                    <div class="relative h-56 overflow-hidden">
                        <?php if($item->image): ?>
                            <img src="<?php echo e(asset('storage/'.$item->image)); ?>" alt="<?php echo e($item->title); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                        <?php else: ?>
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="bg-white/90 backdrop-blur-sm text-brand-700 text-xs font-bold px-3 py-1 rounded-full shadow-sm"><?php echo e($item->created_at->format('d M Y')); ?></span>
                        </div>
                    </div>
                    <div class="p-8">
                        <h3 class="text-2xl font-bold mb-3 text-gray-900 group-hover:text-brand-600 transition"><?php echo e($item->title); ?></h3>
                        <p class="text-gray-500 leading-relaxed line-clamp-3 mb-6"><?php echo e($item->content); ?></p>
                        <a href="<?php echo e(route('news.show', $item)); ?>" class="inline-flex items-center text-brand-600 font-bold hover:text-brand-800 transition">
                            Baca Selengkapnya
    ...
    <footer class="bg-gray-900 text-gray-400 py-12 border-t border-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-sm">&copy; <?php echo e(date('Y')); ?> Klub Keluarga. All rights reserved.</p>
        </div>
    </footer>
</body>
</html><?php /**PATH D:\Xampp\htdocs\ticketing\resources\views/welcome.blade.php ENDPATH**/ ?>